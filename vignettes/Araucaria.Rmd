...
```{r sdm_area}
sa <- sdm_area(study_area, cell_size = 10000, crs = 6933)
```
...
```{r world_clim_future}
## Download current bioclimatic variables
WorldClim_data("input_data/WorldClim_data_future/",period = "future", year = c('2050', '2090'), ssp = c('245','585'), resolution = 10)
