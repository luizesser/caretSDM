...
Alternative to that can be seen in vignettes("Salminus") where we build SDMs for a fish species
using river lines in a simplefeatures object instead of cells in a grid.
