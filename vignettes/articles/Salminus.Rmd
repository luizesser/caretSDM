---
title: "Modeling Species Distributions in Continental Water Bodies"
...
with NAs as predictors. When `sdm_area` is a grid, it will assign records to each cell. Here, as a
line is being used, it is very unlikely that a record will fall exactly above a line. The solution
presented here is the use of `sf::st_nearest_feature` function, which will address each species
record to its closest river line.
