...
```{r benchmark_start1, include=TRUE, eval=FALSE}
prep_biomod2_res <- prep_biomod2()
prep_sdm_res <- prep_sdm()
prep_caretSDM_res <- prep_caretSDM()
```

```{r benchmark_prep2, include=TRUE, eval=FALSE}
...
```{r benchmark_start2, include=TRUE, eval=FALSE}
...
```{r benchmark_fit2, include=TRUE, eval=FALSE}
...
```{r benchmark_start3, include=TRUE, eval=FALSE}
post_biomod2(fit_biomod2_res)
post_sdm(fit_sdm_res)
post_caretSDM(fit_caretSDM_res)
```

```{r benchmark_post2, include=TRUE, eval=FALSE}
...
```{r benchmark_complete2, include=TRUE, eval=FALSE}
...
bench_res_prep <- readRDS("benchmark_data/bench_res_prep.rds")
bench_res_fit <- readRDS("benchmark_data/bench_res_fit.rds")
bench_res_post <- readRDS("benchmark_data/bench_res_post.rds")
bench_res_complete <- readRDS("benchmark_data/bench_res_complete.rds")
```
