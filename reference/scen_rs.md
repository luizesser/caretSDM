...
A `stars` object with bioclimatic variables (bio1, bio4 and bio12) and
four future scenarios for the Rio Grande do Sul state in Brazil. Data
from MIROC6 GCM from WorldClim 2.1 at 10 arc-min resolution.
