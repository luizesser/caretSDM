...
test_that("pseudoabsences - normal", {
  ...
  i3 <- pseudoabsences(i3, method = "random", variables_selected = "vif", n_set = 1)
  expect_equal("random", pseudoabsence_method(i3))
  expect_equal("random", pseudoabsence_method(i3$occurrences))
  i4 <- pca_predictors(i)
  i4 <- pseudoabsences(i4, method = "random", variables_selected = "pca", n_set = 1)
