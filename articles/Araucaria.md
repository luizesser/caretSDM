...
#> 2 naive_bayes 0.9759273 0.9019089    0.981675    0.920225
```
...
#> m1.1  naive_bayes 0.9567460 0.8422619     0.98800     0.85425        0.93100
#> m2.1  naive_bayes 0.9815820 0.9152930     0.95225     0.96300        0.97475
#> m3.1  naive_bayes 0.9684524 0.8846154     1.00000     0.88450        0.93350
#> m4.1  naive_bayes 0.9654991 0.8986722     0.97550     0.92300        0.95275
#> m5.1  naive_bayes 0.9812500 0.9365385     0.97500     0.96150        0.97500
#> m6.1  naive_bayes 0.9846612 0.9496337     0.98800     0.96150        0.97675
#> m7.1  naive_bayes 0.9776442 0.8657051     0.98750     0.87825        0.93450
...
#> m2.1         0.93225   0.97475 0.95225 0.96300    0.60750        0.57775
...
#> m2.1               0.65900           0.95750  0.95600 0.90900       0.82825
...
#> m2.1        0.99125      0.60750        0.00650     0.8723333     20.5    13.25
...
#> m2.1          19.50           1.00         12.75           2.75 0.7932500  NaN
#> m3.1          20.50           0.25         11.50           1.75 0.5507500  NaN
#> m4.1          20.00           0.75         12.00           2.75 0.8580000  NaN
#> m5.1          20.00           1.50         12.00           2.50 0.8685000  NaN
#> m6.1          20.25           1.25         12.50           2.75 0.8602500  NaN
#> m7.1          20.25           0.75         11.00           3.50 0.6552500  NaN
...
#> m1.1         0.09750 0.06112142 0.28293289    0.04770744    0.23938585
#> m2.1         0.09750 0.06140340 0.20337608    0.06741105    0.16694410
...
#> m2.1        0.09550567       0.09430580  0.09550567 0.06741105 0.06959107
...
#> m2.1         1.4142136       1.9148542        2.3629078 0.4135000     NA
#> m3.1         0.5000000       1.5000000        1.5000000 0.3576367     NA
#> m4.1         0.5773503       0.8164966        0.8164966 0.2033855     NA
#> m5.1         1.0000000       1.6329932        1.2909944 0.2630000     NA
#> m6.1         1.2583057       1.7078251        1.7078251 0.2795000     NA
#> m7.1         0.9574271       2.4494897        2.6457513 0.2942962     NA
...
#> 2 naive_b… 0.976 0.902       0.982       0.920            0.955            0.972
...
end_time <- Sys.time()
end_time - start_time
#> Time difference of 2.248894 mins
```
