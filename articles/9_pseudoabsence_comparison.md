...
run_sdm <- function(pseudoabsence_method, ...) {
  ...
  i <- input_sdm(oc, sa) |> 
    ...
    pseudoabsences(method = pseudoabsence_method, 
                   variables_selected = "vif", ...) |> 
    train_sdm(algo = c("naive_bayes", "kknn", "svmRadial", "nnet", "rf", "fda", "glm"), 
...
ggplot(perf_all, aes(x = algo, y = ROC, fill = method)) +
  ...
  scale_fill_manual(values = c("Random"                   = "#4DA6C8",
...
![](9_pseudoabsence_comparison_files/figure-html/performance-plot-1.png)
...
![](9_pseudoabsence_comparison_files/figure-html/plot-random-e-1.png)
...
![](9_pseudoabsence_comparison_files/figure-html/plot-random-pa-1.png)
...
![](9_pseudoabsence_comparison_files/figure-html/plot-bioclim-1.png)
...
![](9_pseudoabsence_comparison_files/figure-html/plot-bioclim-pa-1.png)
...
![](9_pseudoabsence_comparison_files/figure-html/plot-buffer-1.png)
...
![](9_pseudoabsence_comparison_files/figure-html/plot-buffer-pa-1.png)
...
pred_vals <- data.frame(random = get_ensembles(sdm_random)[1,1][[1]][,"average"],
...
![](9_pseudoabsence_comparison_files/figure-html/corrplot-1.png)
...
![](9_pseudoabsence_comparison_files/figure-html/scatterplots-1.png)
...
![](9_pseudoabsence_comparison_files/figure-html/scatterplots2-1.png)
...
ggplot(pred_vals, aes(x = bioclim, y = buffer)) +
  ...
  annotate("text", x = 0.7, y = 0.1,
           ...
           hjust = 0, size = 4, colour = "black",
           fontface = "bold") +
  labs(title = "Environmental Constrain vs. Geographical Constrain",
       x = "Environmental Constrain", y = "Geographical Constrain") +
  theme_minimal(base_size = 11)
```

![](9_pseudoabsence_comparison_files/figure-html/scatterplots3-1.png)
...
```
    ...
    ##  [76] generics_0.1.4          recipes_1.3.2           maxnet_0.1.4           
